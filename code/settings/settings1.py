...
# оружия
weapon_data = {
    'sword': {'cooldown': 100, 'damage': 100, 'graphic': '../graphics/weapons1/sword/full.png'},
    'axe': {'cooldown': 300, 'damage': 150, 'graphic': '../graphics/weapons1/axe/full.png'},
    'lance': {'cooldown': 400, 'damage': 200, 'graphic': '../graphics/weapons1/lance/full.png'}
}

# магия
magic_data = {
    'flame': {'cooldown': 100, 'strength': 100, 'cost': 20, 'graphic': '../graphics/particles1/flame/fire.png',
              'sound': '../audio/flame.wav'},
    'heal': {'cooldown': 100, 'strength': 20, 'cost': 20, 'graphic': '../graphics/particles1/heal/heal.png',
             'sound': '../audio/heal.wav'},
    'spark': {'cooldown': 100, 'strength': 130, 'cost': 30, 'graphic': '../graphics/particles1/spark/spark.png',
